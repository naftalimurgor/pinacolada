...
const FilterSidebar = () => {
  return (
    <div className="w-1/4 p-4 border-r bg-white">
      <input type="text" placeholder="Search for name or ticker" className="w-full p-2 mb-4 border rounded" />
      ...
      <input type="number" placeholder="Volume From" className="w-full p-2 mb-4 border rounded" />
      <input type="number" placeholder="Liquidity From" className="w-full p-2 mb-4 border rounded" />
    </div>
  );
};
