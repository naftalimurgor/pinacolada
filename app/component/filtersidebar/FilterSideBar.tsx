  ...
  return (
    <div className="w-full md:w-1/4 p-6 bg-white shadow-md rounded-lg space-y-4">
      ...
      <div>
        ...
        <select className="w-full p-3 border border-gray-300 rounded-md focus:outline-hidden focus:ring-2 focus:ring-blue-500">
      ...
      <div>
        ...
        <div className="flex space-x-2">
          <input
            type="number"
            placeholder="From"
            className="w-full p-3 border border-gray-300 rounded-md focus:outline-hidden focus:ring-2 focus:ring-blue-500 no-spinner"
          />
          <input
            type="number"
            placeholder="To"
